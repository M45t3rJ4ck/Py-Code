...
# To do so go to http://www.pygame.org/download.shtml and install the appropriate version for your computer and Python 2.7.
# Note: You do not want to download the "source" for pygame, but rather the pygame "binary" for your operating system. 
...
# Get the width and height of the images in order to do boundary detection (i.e. make sure the image stays within screen boundaries or know when the image is off the
#screen).
