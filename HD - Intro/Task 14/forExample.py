...
for i in range (0, rangeNum):   #  We define a for loop that runs from 0 to the entered number. i is the current number that the loop is on.
	...
	if i%2 == 0 : # This checks if the current number of the loop is EVEN. (i.e. if you divide it by 2, you get a 0 remainder. This is what the %,
#or MODULUS command does.)
		print(i)
