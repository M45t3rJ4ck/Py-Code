...
# You get different TYPES of variables : Strings, integers and Floats . These different types are known as DATA TYPES.
...
# Well there are certain patterns like strings having double or single quotation marks, integers just being numbers or a certain format and floating point types with decimal places
text = "Welcome"  
number = 10
numberStr = "10"
...
# Heed that 10 is not the same as "10", they are two different types, thus before you can use them, you need to 'cast' them which we will cover later
