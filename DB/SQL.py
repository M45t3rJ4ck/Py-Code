# Here I'll show you how to work with SQLite databases in Python. A database makes it easy for you to organize your
# data for storage and fast searching. I show how to install SQLite and use it in this tutorial:
# https://youtu.be/QjICgmk31js. You need the SQLite module to use it
...
try:
    db_conn.execute("CREATE TABLE Employees(ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, FName TEXT NOT NULL, "
                    "LName TEXT NOT NULL, Age INT NOT NULL, Address TEXT, Salary REAL, HireDate TEXT);")
...
# To insert data into a table we use INSERT INTO, followed by the table name and the item name and the data to assign
#  to those items.
...
# You can update a value in a table by referencing something unique like the ID or anything else with the UPDATE command.
...
# Delete matching data from the database by referencing the table name and something unique
