...
# You can set attributes on creation or by calling methods
...
# Pack positions widgets by allowing them to define their position (Top, Right, Bottom, Left) and their fill direction
# (X, Y, BOTH, NONE) inside of a box
root = Tk()
frame = Frame(root)

# Define where the widgets should be placed and how they should be stretched to fill the space
